export default class DxfSettingsPanel {
  ...
  buildPage() {
    ...
    div.innerHTML = `
            <table>
                ...
                <tr>
                    <td title="PDF ！">
                         :<span id="txtCurrScale">${scale || "<无>"}</span>)
                    </td>
                    <td style="font-size: 11px;">
                        ...
                        <div>
                            <input type="button" id="btnSetScale" value="_"></input>
                            <input type="button" id="btnClearScale" value="_"></input>
                        </div>
                    </td>
                </tr>
            </table>
  ...
  addEventHandlers() {
    ...
    const txtDistMeasureResult = document.getElementById(
      "txtDistMeasureResult"
    );
  ...
  onPointerMove = (e) => {
    ...
    const viewerRight =
      viewerContainer.clientLeft + viewerContainer.clientWidth;
    const viewerBottom =
      viewerContainer.clientTop + viewerContainer.clientHeight;
